...
function QuantitySelector ({ quantity, min = 1, max, step = 1, handleIncrement, handleDecrement, compact = false }) {
  ...
  const inputStyle = 'text-center input input-bordered arrow-hide px-12 w-full'
